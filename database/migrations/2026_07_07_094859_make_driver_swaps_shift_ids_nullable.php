...
return new class extends Migration
{
    ...
    {
        // Không hỗ trợ rollback: dữ liệu hiện tại có from_shift_id = null,
        // không thể insert lại vào schema cũ với NOT NULL constraint.
        throw new \RuntimeException('This migration cannot be rolled back — data integrity would be lost.');
    }
};
