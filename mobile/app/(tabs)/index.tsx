  ...
  return (
    <ScrollView style={st.container} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#4F46E5" />}>
      ...
      <View style={st.statRow}>
        ...
        <View style={[st.statCard, { backgroundColor: "#EEF2FF", borderColor: "#A5B4FC" }]}>
        ...
        <View style={[st.statCard, { backgroundColor: "#D1FAE5", borderColor: "#86EFAC" }]}>
      ...
      {activeTrips.length === 0 ? (
        ...
        activeTrips.slice(0, 5).map((t) => {
          ...
          return (
            <TouchableOpacity key={t.id} style={[st.tripCard, { borderColor: sc.text + "40", borderWidth: 1 }]} activeOpacity={0.7}
...
const st = StyleSheet.create({
  ...
  statCard: { flex: 1, padding: 16, borderRadius: 14, alignItems: "center", gap: 6, borderWidth: 1 },
  ...
  tripCard: { flexDirection: "row", alignItems: "center", backgroundColor: "#fff", marginHorizontal: 16, marginBottom: 6, padding: 14, borderRadius: 14, borderWidth: 1, borderColor: "#F3F4F6", gap: 12 },
